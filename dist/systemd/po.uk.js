...
return plural;
 ...
 "Search the logs with a combination of terms:": [
  null,
  "Шукати у журналі за такою комбінацією ключів:"
 ],
 "Seconds": [
  null,
  "Секунди"
 ...
 "There was $0 failed login attempt since the last successful login.": [
  ...
  "З часу останнього успішного входу до системи сталася $0 невдала спроба входу.",
  "З часу останнього успішного входу до системи сталася $0 невдалих спроби входу.",
  "З часу останнього успішного входу до системи сталася $0 невдалих спроб входу."
 ],
 "This didn't work, please try again": [
  null,
  "Це спрацювало, будь ласка, повторіть спробу"
 ],
 ...
 "View details and history": [
  null,
  "Переглянути подробиці і журнал"
 ],
 ...
 "You can not gain administrative access.": [
  null,
  "Ви не можете набути прав адміністративного доступу."
 ],
 ...
 "any free-form string as regular expression": [
  null,
  "будь-який рядок довільного формату як формальний вираз"
 ],
 "asset tag": [
  null,
  "мітка активу"
