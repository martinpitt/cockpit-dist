...
return plural;
 ...
 "Failed to save changes in /etc/motd": [
  null,
  "Impossible de sauvegarder les modifications dans /etc/motd"
 ],
 "Failed to start": [
  null,
  "Échec du démarrage"
 ...
 "Hours must be a number between 0 and 23": [
  null,
  "Les heures doivent être un nombre compris entre 0 et 23"
 ],
 "ID": [
  null,
  "ID"
 ...
 "Minutes must be a number between 0 and 59": [
  null,
  "Les minutes doivent correspondre à un nombre compris entre 0 et 59"
 ],
 "Mitigations": [
  null,
  "Mitigations"
 ...
 "Search the logs with a combination of terms:": [
  null,
  "Recherchez les journaux avec une combinaison de termes :"
 ],
 "Seconds": [
  null,
  "Secondes"
 ...
 "Select unit state": [
  null,
  "Sélectionnez l'état de l'unité"
 ],
 "Send": [
  null,
  "Envoyer"
 ...
 "There was $0 failed login attempt since the last successful login.": [
  ...
  "Il y a eu $0 tentative de connexion échouée depuis la dernière connexion réussie.",
  "Il y a eu $0 tentatives de connexion échouées depuis la dernière connexion réussie."
 ],
 ...
 "You can not gain administrative access.": [
  null,
  "Vous ne pouvez pas obtenir l’accès administrateur."
 ],
 ...
 "any free-form string as regular expression": [
  null,
  "toute chaîne comme expression rationnelle"
 ],
 "asset tag": [
  null,
  "Étiquette d’actif"
