...
return plural;
 ...
 "$0 critical hit": [
  ...
  "$0 golpe, incluyendo uno crítico",
  "$0 golpes, incluyendo críticos"
 ],
 ...
 "$0 important hit": [
  ...
  "$0 golpe, incluyendo uno importante",
  "$0 golpes, incluyendo los importantes"
 ],
 ...
 "$0 low severity hit": [
  "$0 low severity hits",
  "$0 bajo con un golpe severo",
  "$0 bajo con golpes severos"
 ],
 "$0 moderate hit": [
  "$0 hits, including moderate",
  "$0 golpe, incluyendo uno moderado",
  "$0 golpes, incluyendo moderados"
 ],
 "$0 service has failed": [
  "$0 services have failed",
  "Falló $0 servicio",
  "Fallaron $0 servicios"
 ],
 "$0 will be installed.": [
  null,
  "Se instalará $0."
 ...
 "Allow running (unmask)": [
  null,
  "Permite la ejecución (sin máscara)"
 ],
 "Asset tag": [
  null,
 ...
 "Debug and above": [
  null,
  "Depurando empezando por arriba"
 ],
 "Decrease by one": [
  null,
  ""
 ...
 "Domain $0 could not be contacted": [
  null,
  "No se pudo contactar con el dominio $0"
 ],
 "Domain $0 is not supported": [
  null,
  "El dominio $0 no está soportado"
 ],
 "Domain address": [
  null,
 ...
 "Enable stored metrics": [
  null,
  "Habilitar guardado de métricas"
 ],
 "Enabled": [
  null,
  "Habilitado"
 ...
 "Host name should not be changed in a domain": [
  null,
  "El nombre del anfitrión no debería cambiarse en un dominio"
 ],
 "Hostname": [
  null,
 ...
 "Info and above": [
  null,
  "Información empezando desde arriba"
 ],
 "Insights: ": [
  null,
  "Insights: "
 ...
 "Joining a domain requires installation of realmd": [
  null,
  "Para unirse a un dominio debe instalar un realmd"
 ],
 ...
 "Limited access mode restricts administrative privileges. Some parts of the web console will have reduced functionality.": [
  null,
  "El modo de acceso limitado restringe los privilegios administrativos. Algunas parte de la consola web tendrán funcionalidad reducida."
 ],
 ...
 "Search the logs with a combination of terms:": [
  null,
  "Encontrar registros con una combinación de términos:"
 ],
 "Seconds": [
  null,
  "Segundos"
 ...
 "There was $0 failed login attempt since the last successful login.": [
  ...
  "Hubo $ 0 intento fallido de inicio de sesión desde el último inicio de sesión exitoso.",
  "Hubo $ 0 intentos fallidos de inicio de sesión desde el último inicio de sesión exitoso."
 ],
 "This didn't work, please try again": [
  null,
  "Esto no ha funcionado; inténtelo de nuevo"
 ],
 ...
 "Warning and above": [
  null,
  "Precaución empezando por arriba"
 ],
 ...
 "failed to list ssh host keys: $0": [
  null,
  "incapaz de mostrar las claves ssh del anfitrión: $0"
 ],
 "graphs": [
  null,
  "gráficos"
