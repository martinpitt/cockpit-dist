...
return plural;
 ...
 "There was $0 failed login attempt since the last successful login.": [
  ...
  "Была $0 неудачная попытка с последнего успешного входа.",
  "Было $0 неудачных попытки с последнего успешного входа.",
  "Было $0 неудачных попыток с последнего успешного входа."
 ],
