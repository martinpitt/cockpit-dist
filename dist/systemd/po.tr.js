...
return plural;
 ...
 "Domain $0 could not be contacted": [
  null,
  "$0 etki alanıyla iletişim kurulamadı"
 ],
 "Domain $0 is not supported": [
  null,
  "$0 etki alanı desteklenmiyor"
 ],
 "Domain address": [
  null,
  "Etki alanı adresi"
 ...
 "Enable stored metrics": [
  null,
  "Ölçümleri saklamayı etkinleştir"
 ],
 "Enabled": [
  null,
  "Etkinleştirildi"
 ...
 "Host name should not be changed in a domain": [
  null,
  "Bir etki alanında anamakine adı değiştirilmemelidir"
 ],
 "Hostname": [
  null,
  "Anamakine adı"
 ...
 "Hours must be a number between 0 and 23": [
  null,
  "Saat, 0 ile 23 arasında bir sayı olmak zorundadır"
 ],
 "ID": [
  null,
  "Kimlik"
 ...
 "Minutes must be a number between 0 and 59": [
  null,
  "Dakika, 0 ile 59 arasında bir sayı olmak zorundadır"
 ],
 "Mitigations": [
  null,
  "Risk azaltmaları"
 ...
 "Search the logs with a combination of terms:": [
  null,
  "Günlükleri terimlerin bir birleşimi ile ara:"
 ],
 "Seconds": [
  null,
  "Saniye"
 ...
 "There was $0 failed login attempt since the last successful login.": [
  ...
  "Son başarılı oturum açmadan bu yana $0 başarısız oturum açma denemesi oldu.",
  "Son başarılı oturum açmadan bu yana $0 başarısız oturum açma denemesi oldu."
 ],
 ...
 "View details and history": [
  null,
  "Ayrıntıları ve geçmişi görüntüle"
 ],
 ...
 "You can not gain administrative access.": [
  null,
  "Yönetimsel erişim elde edemezsiniz."
 ],
 ...
 "any free-form string as regular expression": [
  null,
  "düzenli ifade olarak herhangi bir serbest biçimli dizgi"
 ],
 "asset tag": [
  null,
  "demirbaş etiketi"
