...
return plural;
 ...
 "Domain $0 could not be contacted": [
  null,
  "Er kan geen contact gemaakt worden met domein $0"
 ],
 "Domain $0 is not supported": [
  null,
  "Domein $0 wordt niet ondersteund"
 ],
 "Domain address": [
  null,
  "Domeinadres"
 ...
 "Host name should not be changed in a domain": [
  null,
  "Hostnaam mag niet worden gewijzigd in een domein"
 ],
 "Hostname": [
  null,
  "Hostnaam"
 ...
 "Search the logs with a combination of terms:": [
  null,
  "Zoek in de logboeken met een combinatie van termen:"
 ],
 "Seconds": [
  null,
  "Seconden"
 ...
 "There was $0 failed login attempt since the last successful login.": [
  ...
  "Er was $0 mislukte aanmeldingspoging sinds de laatste succesvolle aanmelding.",
  "Er waren $0 mislukte aanmeldingspogingen sinds de laatste succesvolle aanmelding."
 ],
 "This didn't work, please try again": [
  null,
  "Dit werkte niet, probeer het opnieuw"
 ],
 ...
 "View details and history": [
  null,
  "Bekijk details en geschiedenis"
 ],
 ...
 "You can not gain administrative access.": [
  null,
  "Je kunt geen administratieve toegang krijgen."
 ],
 ...
 "any free-form string as regular expression": [
  null,
  "elke vrije tekenreeks als reguliere expressie"
 ],
 "asset tag": [
  null,
  "asset-tag"
